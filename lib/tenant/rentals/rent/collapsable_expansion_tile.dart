...
/// [CollapsableExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [CollapsableExpansionTile].
///
/// {@tool dartpad}
...
class CollapsableExpansionTile extends StatefulWidget {
  ...
  @override
  State<CollapsableExpansionTile> createState() =>
      CollapsableExpansionTileState();
}

class CollapsableExpansionTileState extends State<CollapsableExpansionTile>
